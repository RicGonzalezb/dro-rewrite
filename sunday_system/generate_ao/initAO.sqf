...
_allowedLocTypes = ["NameLocal", "NameVillage", "NameCity", "NameCityCapital", "Airport", "Strategic", "StrongpointArea"];
_removeStrongpointArea = ["SPE_Normandy"];
if (worldName in _removeStrongpointArea) then { _allowedLocTypes = _allowedLocTypes - ["StrongpointArea"]; };

_locList = nearestLocations [[_worldCenter, _worldCenter], _allowedLocTypes, _size];
